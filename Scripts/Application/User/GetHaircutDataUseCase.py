...
class GetHaircutDataUseCase:
    ...
    def execute(self) -> dict:
        ref_haircuts_to_bonus = self.haircut_config_repo.get_config_value("count_ref_haircuts_to_bonus")
        coins_for_referral = self.haircut_config_repo.get_config_value("coins_for_referral")
        coins_free_haircut = self.haircut_config_repo.get_config_value("coins_for_free_haircut")

        return {
            "count_ref_haircuts_to_bonus": ref_haircuts_to_bonus,
            "coins_for_referral": coins_for_referral,
