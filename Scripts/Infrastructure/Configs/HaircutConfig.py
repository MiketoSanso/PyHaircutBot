...
class HaircutConfig:
    ...
    count_ref_haircuts_to_bonus: int = 0
    coins_for_referral: int = 0
    ...
    def __post_init__(self):
        ...
        if self.count_ref_haircuts_to_bonus < 0 or self.count_ref_haircuts_to_bonus > 50:
            raise ValueError("count must be between 0 and 50")
        if self.coins_for_referral < 0 or self.coins_for_referral > 1000:
